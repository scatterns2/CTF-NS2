...
Script.Load("lua/Weapons/SentryAbility.lua")
Script.Load("lua/Weapons/ArmoryAbility.lua")
Script.Load("lua/Weapons/PhaseGateAbility.lua")
Script.Load("lua/Weapons/ObservatoryAbility.lua")
...
if Client then
    ...
    function MarineStructureAbility:CreateBuildMenu()
        ...
        if not self.buildMenu then        
            self.buildMenu = GetGUIManager():CreateGUIScript("Marines/GUIMarineBuildMenu")            
        end
