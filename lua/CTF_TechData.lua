local function CTFTechAdditions(techData)
	...
	table.insert(techData, { 	[kTechDataId] = kTechId.Flag,
								[kTechDataMapName] = Flag.kMapName })
	...
	table.insert(techData, {	[kTechDataId] = kTechId.HealGun,
								[kTechDataMapName] = HealGun.kMapName,
								[kTechDataDisplayName] = "HEAL_GUN",
								[kTechDataModel] = Welder.kModelName })
